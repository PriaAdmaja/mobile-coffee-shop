    ...
    return (
        <View style={{ flex: 1, padding: 22 }}>
            ...
            <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                <Image source={require('../../assets/icons/history.png')} style={{ width: 120, height: 120 }} />
                <Text style={{ fontWeight: '900', fontSize: 28, paddingTop: 35, color: '#000000' }}>No history yet</Text>
